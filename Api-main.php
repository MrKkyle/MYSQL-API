<?php session_start();?>
<head>
<link rel = "stylesheet" type = "text/css" href = "Api-main.css" ></link>   
</head>
...
<body>
    ...
    <div class = "createdb">
        ...
        <div class = "line"></div>
        <br>
        <form method = "post" action = "Api-db.php">
            ...
            Create Table</button>
            <button class = "button4" id = "btn5" type = "submit" onclick = "window.location.href = 'Api-table.php';">No</button>
            <br>
            <br>
            ...
            <form method = "post" action = "Api-db.php">
                ...
                <br>
                    Number of Table Columns:
                                    <select style = "width:50px; height:25px; border-radius:5px;" name = "columnNumber">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                ...
                <br>                    
                Column 1:
                <input type = "text" placeholder = "Name" name = "column1"autocomplete = "off" > <input type = "var" placeholder = "type" name = "c1type" autocomplete = "off">
                <br>
                Column 2:
                <input type = "text" placeholder = "Name" name = "column2" autocomplete = "off"> <input type = "var" placeholder = "type" name = "c2type" autocomplete = "off">
                <br>
                Column 3:
                <input type = "text" placeholder = "Name" name = "column3" autocomplete = "off"> <input type = "var" placeholder = "type" name = "c3type" autocomplete = "off">
                <br>
                Column 4:
                <input type = "text" placeholder = "Name" name = "column4" autocomplete = "off"> <input type = "var" placeholder = "type" name = "c4type" autocomplete = "off">
                <br>
    ...
    <div class = "connectdb" id = "connect">
        ...
        <div class = "line"></div>
        <br>
        <form method = "post" action = "Api-tableselect.php">
